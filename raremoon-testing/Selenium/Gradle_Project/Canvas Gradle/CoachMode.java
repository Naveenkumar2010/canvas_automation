...
public class CoachMode 
{
	...
	public void coachMode() throws IOException
	{
		...
		{		
			...
			Thread.sleep(2000);
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[39]/ul/div[2]/div[1]/ul/li[4]/a")).click();
			Thread.sleep(2000);
...
/*		//Navigating to another user
		...
		try
		{
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[41]/a")).click();
