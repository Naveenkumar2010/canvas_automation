...
public class WebBot {
    ...
    public void wedBot() throws IOException, InterruptedException
    {
    	...
    	{
    		Thread.sleep(2000);
    		Browser.getInstance().findElement(By.className("modalBatchTextArea")).clear();
    		WebElement Autoreply = Browser.getInstance().findElement(By.className("modalBatchTextArea"));
    	...
    	//Adding Action into the WebBot Deatil
