	...
	public void searchfield1() throws IOException
{
	   ...
	   //Search By name
		...
		{			
			...
			//WebElement uploadElement = Browser.getInstance().findElement(By.className("resumeUploadPotrait"));
			...
			//Runtime.getRuntime().exec("D:\\D Drive Data\\AutoIT\\FileUpload\\Resumeupload.exe"); //By Using AutoIT - we are uploading resume
			
			Runtime.getRuntime().exec("C:\\Users\\naveenkumar.r\\Documents\\AngularAutomation\\FileUpload\\TestUpload.exe");
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[2]/div[5]/div[1]/ul/li[2]/a/img")).click();
