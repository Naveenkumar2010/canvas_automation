...
public class Logout 
{
	...
	public void logout() throws InterruptedException, IOException
	{
		try
		{
			...
			WebElement profile = Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[39]/ul/li[contains(@class,'profile-icon')]/a"));
			actions.moveToElement(profile);
			actions.build().perform();
			
			Thread.sleep(2500);
			
			WebElement Number = Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[39]/ul/div[2]/div[1]/ul/li[1]/a/span[1]"));
			String PhoneNo= Number.getText();
        
			System.out.println("Canvas US-Number : " +PhoneNo + '\n');	
			
			
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[39]/ul/div[2]/div[1]/ul/li[5]/a")).click();
