	...
	public void chat() throws InterruptedException, IOException
	{
		...
		try
		{
			Browser.getInstance().findElement(By.id("search")).sendKeys("Vasanth");
	   	 	Thread.sleep(5000);
	   	 	WebElement Search = Browser.getInstance().findElement(By.xpath("/html/body/div[2]/div[1]/div[2]/div[2]/div[2]/button"));	   	 
	   	 	Search.isEnabled();
	   	 	Search.click();		
	   	 	...
	   	 	Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[2]/div[5]/div[1]/div[1]/span[1]/i")).click();
	   	 	Thread.sleep(1000);
	     	...
	     	Browser.getInstance().findElement(By.xpath("/html/body/div[\".*[^0-99].*\"]/div[\".*[^0-99].*\"]/div[\".*[^0-99].*\"]/div[\".*[^0-99].*\"]/div[\".*[^0-99].*\"]/div/form/div[3]/input")).sendKeys("Notes"); 
	   	    ...
	   	    //Add an attachment:
	   	 	...
	   	 	Thread.sleep(5000);
			Runtime.getRuntime().exec("C:\\Users\\naveenkumar.r\\Documents\\AngularAutomation\\FileUpload\\ResourceUpload.exe");	   	   	 	
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='chat-drawer']/div[1]/div/div[2]/div[1]/div/span")).click();
	   	 	...
	   	 	WebElement Resclick = Browser.getInstance().findElement(By.xpath("//*[@class='chatattachementfile']/ol/li/a[contains(text(),'Testdoc.pdf')]"));
	   	 	Resclick.isEnabled();
	   	 	Resclick.click();   	 	
		...
		//Adding Message using Library Quick Add
		try
		...
		try
		{
        	...
        	Browser.getInstance().findElement(By.xpath("//*[@id='chat-drawer']/ul/li[2]/a")).click();   
		...
		try
		{
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='a0d308e1-3238-4171-b788-c4bd1fc2619e']/a/span[2]")).click();
			//Browser.getInstance().navigate().refresh();
			Thread.sleep(8000);
	    ...
	    //Clicking Chat Transcript Modal
	   	...
	   	//Uploading an attachment and resource
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[39]/ul/ol/li[4]")).click();
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='createreply']/span")).click();
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='createreply']/div[3]/div/span")).click();
			...
			Thread.sleep(3000);
	   	 	...
	   	 	WebElement Resclick1 = Browser.getInstance().findElement(By.xpath("//*[@class='chatattachementfile']/ol/li/a[contains(text(),'Testdoc.pdf')]"));
	   	 	Resclick1.isEnabled();
	   	 	Resclick1.click();   	 	
...
//			
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='editreply']/div[3]/div[1]/span")).click();
			...
			Thread.sleep(3000);
	   	 	...
	   	 	WebElement Resclick2 = Browser.getInstance().findElement(By.xpath("//*[@class='chatattachementfile']/ol/li/a[contains(text(),'Testdoc.pdf')]"));
	   	 	Resclick2.isEnabled();
	   	 	Resclick2.click();   	 	
		    ...
		    Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[2]/div[5]/div[1]/div[1]/div/span/img")).click();
		    
		    Thread.sleep(7000);		    

		    Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/nav/ul/li[2]/a")).click();
			...
			reportObj.writeReport(reportValues3);
	   	 	log.info("Filtering candidates in chat page");
		}
		catch(Exception e)
		{
			e.printStackTrace();
			...
			reportObj.writeReport(reportValues3);
	   	 	log.error("An error occurred while filtering candidates in Scheduleing messages & Saving Messages  in chat page");
		}
