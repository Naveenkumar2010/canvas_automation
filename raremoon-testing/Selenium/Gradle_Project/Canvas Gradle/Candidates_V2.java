...
public class Candidates_V2 {
	...
	//Candidate Visibitlity- Performing Quick Edit from Mine View
	try
...
//			Browser.getInstance().findElement(By.id("OverAllCheck")).click();
	...
	{    
		...
		Browser.getInstance().findElement(By.xpath("//*[@id='sourceListByID']/ul/li[3]/div/input")).click();
		
		Thread.sleep(4000);
		
		Browser.getInstance().findElement(By.xpath("//*[@id='sourceListByID']/div[2]/input")).click();
	...
	catch(Exception e)
	{
		...
		reportObj.writeReport(reportValues);
		String[] reportValues1 ={"Enabling Recruiter filter form Mine View","Fail"};
		reportObj.writeReport(reportValues1);
		...
		reportObj.writeReport(reportValues6);		
		String[] reportValues7 ={"Successfuly enabled/removed Added By column","Fail"};
		reportObj.writeReport(reportValues7);
