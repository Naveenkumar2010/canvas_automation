...
public class Preference {
	...
	public void PreferencePage() throws IOException  {
		...
		try
		{
			...
			WebElement profile = Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[39]/ul/li[contains(@class,'profile-icon')]/a/img"));
			actions.moveToElement(profile);
			actions.build().perform();
			
			Thread.sleep(2000);					
						
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[39]/ul/div[2]/div[1]/ul/li[3]/a")).click();
	...
	// Turning OFF the OOO
		...
		try
		{
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/nav/ul/li[1]/a")).click();  
			...
			Browser.getInstance().findElement(By.xpath("//*[@id='wrap']/div[1]/div[1]/div[6]/div[42]/a")).click();
